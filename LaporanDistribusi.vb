...
Public Class LaporanDistribusi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PerformingRight.LaporanDistribusi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanDistribusi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanDistribusi = New LaporanDistribusi()
        rpt.Site = Me.Site
        Return rpt
    End Function
